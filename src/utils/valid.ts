 ...
 * @returns 
 */
export const isLengthOver = ({val, minLen, maxLen}: LengthOverOptions = {} as LengthOverOptions) => {
    if ( !val?.trim() ) {
        console.error('val is empty.');
        return false;
    }
 ...
 * @returns 
 */
export const isSafeUrl = (val: string): boolean => {
    try {
        // 절대 URL 검사
...
export const Type = {
     ...
     * @returns 
     */
    isNotHangul : (val: string): boolean => {
        if ( !val?.trim() ) {
            console.error('val is empty.');
            return false;
        }
...
export const Format = {
     ...
     * @returns 
     */
    isValidPhoneNum : (val: string): boolean => {
        if ( !val?.trim() ) {
            console.error('val is empty.');
            return false;
        }
     ...
     * @returns 
     */
    isInternetPhoneNum : (val: string): boolean => {
        if ( !val?.trim() ) {
            console.error('val is empty.');
            return false;
        }
     ...
     * @returns 
     */
    isTollFreePhoneNum : (val: string): boolean => {
        if ( !val?.trim() ) {
            console.error('val is empty.');
            return false;
        }
     ...
     * @returns 
     */
    isVirtualPhoneNum : (val: string): boolean => {
        if ( !val?.trim() ) {
            console.error('val is empty.');
            return false;
        }
     ...
     * @returns 
     */
    isBusinessPhoneNum : (val: string): boolean => {
        if ( !val?.trim() ) {
            console.error('val is empty.');
            return false;
        }
     ...
     * @returns 
     */
    isCellPhoneNum : (val: string): boolean => {
        if ( !val?.trim() ) {
            console.error('val is empty.');
            return false;
        }
     ...
     * @returns 
     */
    isCompanyRegNum : (val: string): boolean => {
        if ( !val?.trim() ) {
            console.error('val is empty.');
            return false;
        }
